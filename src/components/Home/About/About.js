                    ...
                    <div class="row">
                        <div class="col-lg-6 pr-70 md-pr-15 md-mb-50">
                            <div class="sec-title4 mb-30">
                                ...
                                <h2 class="title pb-20">Welcome to Alif Agency, where technology meets innovation </h2>
                                <p class="margin-0">we are dedicated to transforming your digital presence with our cutting-edge solutions and expertise</p>
                            </div>
